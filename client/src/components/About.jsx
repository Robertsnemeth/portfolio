...
const About = () => {
  return (
    <motion.div 
      ...
      className="w-full sm:w-3/4 h-screen flex flex-col gap-8 justify-center border border-l-0 border-r-0 overflow-hidden">
      ...
      <motion.img
        ...
        src={HeroImg} 
        alt="hero image" 
        className='rounded w-48 md:w-72'/>
      <div className='relative px-1'>
        <p className=" text-base lg:text-2xl text-center z-10">
          Hey everyone, my name is Robert Nemeth, I go by Bobby. 
          I am a Full Stack Developer based out of Tacoma, WA. Ive built projects in Python, Java and MERN but I am particularily passionate about React/Next.js. 
